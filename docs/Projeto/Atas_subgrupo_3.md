...
# **REUNIÃO 25/08 - Análise dos Artefatos**
...
Nos **SIGs do NFR Framework**, foram discutidos os requisitos de **segurança, desempenho e usabilidade**, percebendo alinhamento entre os integrantes. Também foi discutida a contextualização geográfica como forma de personalização do conteúdo e as diferenças no nível de detalhamento das nuvens.
...
>
> * **NFR Framework:** Considerar segurança, desempenho e usabilidade como os principais requisitos analisados e utilizar as discussões do grupo para avaliar o nível de detalhamento das operacionalizações.
>
