...
??? note "Rich Picture Individual: João Pedro"
    ...
    <figure style="text-align: center;">
        ...
        <figcaption>
            <p style="text-align: center; font-size: 10pt;">
                Figura: Rich Picture Individual (Fonte: <a href="https://github.com/joaopedro">João Pedro</a>, 2026)
            </p>
        </figcaption>
    </figure>
...
??? note "SIG NFR Framework individual: João Pedro"
    ...
    <figure style="text-align: center;">
        ...
        <figcaption>
            <p style="text-align: center; font-size: 10pt;">
                Figura: SIG NFR Framework Individual (Fonte: <a href="https://github.com/joaopedro">João Pedro</a>, 2026)
            </p>
        </figcaption>
    </figure>
